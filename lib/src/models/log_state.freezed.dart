...
mixin _$LogState {
  ...
  $LogStateCopyWith<LogState> get copyWith =>
      _$LogStateCopyWithImpl<LogState>(this as LogState, _$identity);
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(logEntries));
...
abstract mixin class $LogStateCopyWith<$Res> {
  factory $LogStateCopyWith(LogState value, $Res Function(LogState) _then) =
      _$LogStateCopyWithImpl;
  @useResult
  $Res call({List<LogEntry> logEntries});
}
...
class _LogState extends LogState {
  const _LogState({required final List<LogEntry> logEntries})
      : _logEntries = logEntries,
        super._();
  factory _LogState.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LogStateCopyWith<_LogState> get copyWith =>
      __$LogStateCopyWithImpl<_LogState>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$LogStateToJson(
      this,
    );
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_logEntries));
...
/// @nodoc
abstract mixin class _$LogStateCopyWith<$Res>
    implements $LogStateCopyWith<$Res> {
  factory _$LogStateCopyWith(_LogState value, $Res Function(_LogState) _then) =
      __$LogStateCopyWithImpl;
  @override
  @useResult
  $Res call({List<LogEntry> logEntries});
}
...
/// @nodoc
class __$LogStateCopyWithImpl<$Res> implements _$LogStateCopyWith<$Res> {
