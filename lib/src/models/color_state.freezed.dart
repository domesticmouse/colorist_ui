    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.colorHistory, colorHistory));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, currentColor,
      const DeepCollectionEquality().hash(colorHistory));
...
abstract mixin class $ColorStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ColorData currentColor, List<ColorData> colorHistory});
    ...
    return _then(_self.copyWith(
      currentColor: null == currentColor
          ...
          : currentColor // ignore: cast_nullable_to_non_nullable
              as ColorData,
      colorHistory: null == colorHistory
          ? _self.colorHistory
          : colorHistory // ignore: cast_nullable_to_non_nullable
              as List<ColorData>,
    ));
  }
...
class _ColorState extends ColorState {
  const _ColorState(
      {required this.currentColor, required final List<ColorData> colorHistory})
      : _colorHistory = colorHistory,
        super._();
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.currentColor, currentColor) ||
                other.currentColor == currentColor) &&
            const DeepCollectionEquality()
                .equals(other._colorHistory, _colorHistory));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, currentColor,
      const DeepCollectionEquality().hash(_colorHistory));
